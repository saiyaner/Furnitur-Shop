            ...
            <div class="my-5">
                <div class="mt-5 flex justify-center items-center">
                    <input type="text" placeholder="Search furniture here..."
                        class="w-full md:w-96 px-4 py-2 border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-gray-400">
                </div>
                <div class="mt-4 flex flex-wrap justify-center gap-5 text-sm">
                    <a href="#chair"
                        class="text-gray-700 px-5 py-1 border rounded hover:text-white hover:bg-gray-900 transition">Chair</a>
                    <a href="#table"
                        class="text-gray-700 px-5 py-1 border rounded hover:text-white hover:bg-gray-900 transition">Table</a>
                    <a href="#sofa"
                        class="text-gray-700 px-5 py-1 border rounded hover:text-white hover:bg-gray-900 transition">Sofa</a>
                    <a href="#lamp"
                        class="text-gray-700 px-5 py-1 border rounded hover:text-white hover:bg-gray-900 transition">Lamp</a>
                    <a href="#bed"
                        class="text-gray-700 px-5 py-1 border rounded hover:text-white hover:bg-gray-900 transition">Bed</a>
                </div>
            </div>
        </div>
    </header>
            ...
            <div class="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2">
                ...
                @foreach ($products as $product)
                    <a href="{{ route('detailproduct', ['id' => $product->id]) }}">
                        <div
                            class="bg-white rounded-lg shadow-md overflow-hidden transition-transform md:hover:scale-105">
                            ...
                            <div class="p-4">
                                ...
                                <div class="flex items-center justify-between mt-4">
                                    ...
                                    <button onclick="buyNow('{{ $product->name }}', {{ $product->price }})"
                                        class="bg-yellow-400 hover:bg-yellow-500 text-black font-semibold px-4 py-1  rounded-full text-sm">
                                        BUY NOW
                                    </button>
                                </div>
                            </div>
        ...
        <section class="mb-12 bg-gray-200 rounded-lg p-8">
            <div class="grid md:grid-cols-2 gap-8">
                <div>
                    ...
                    <p class="text-gray-700 mb-6">At Furniuture, we believe every piece of quality products tells a
        ...
        <div class="max-w-7xl mx-auto px-4">
            <div class="grid md:grid-cols-3 gap-8">
                <div>
                    ...
                    <p class="text-sm">Upgrade your life with unique furniture pieces that reflect your individuality.
                        From sleek modern designs to cozy traditional styles, we've got something perfect for every
                        room. Happy shopping!</p>
                </div>
                <div>
            ...
            <div
                class="border-t border-black mt-8 pt-8 flex flex-col md:flex-row justify-between items-center text-sm">
