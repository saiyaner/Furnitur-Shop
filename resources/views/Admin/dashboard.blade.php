...
<body class="bg-gray-100">
    ...
    <div class="flex pt-16"> <!-- Added pt-16 to account for fixed header height -->
        ...
        <aside class="w-56 bg-white border-r border-gray-200 fixed top-16 bottom-0 left-0 h-[calc(100vh-4rem)] overflow-y-auto z-30">
            <div class="py-6 px-5">
                <nav class="space-y-2 flex flex-col justify-start items-start">
                    <a href="#" class="w-full py-2 px-3 text-gray-600 hover:text-gray-900 hover:bg-gray-100 rounded-lg transition-all flex items-center text-sm">
                ...
                <!-- Sign Out Button -->
                <form method="POST" action="{{ route('logout') }}" class="mt-37">
                    @csrf
                    <button type="submit" class="flex items-center gap-x-1 w-fit px-5 py-2 rounded-full text-white hover:text-red-500 hover:bg-white hover:border hover:border-red-500 transition-all justify-center bg-red-500 ms-4">
