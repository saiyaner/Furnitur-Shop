...
<body class="bg-gray-100">
            ...
            <form action="{{ route('admin.products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-6">
                    ...
                    <div id="color-variations-container" class="space-y-4">
                        @php
                            // Get colors from product, fallback to empty array if not set
                            ...
                            $oldColors = old('colors', count($productColors) > 0 ? $productColors : [['name' => '', 'stock' => '', 'hex_code' => '#000000']]);
                        @endphp
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <div>
                                    ...
                                    <div class="flex gap-2">
                                        ...
                                        <input type="text" name="colors[{{ $index }}][hex_code]" 
                                               value="{{ $color['hex_code'] ?? '#000000' }}"
                                               placeholder="#000000"
                ...
                <div class="mb-6">
                    ...
                    <input type="number" name="rate" id="rate" step="0.1" min="0" max="5" value="{{ old('rate', $product->rate) }}"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                    @error('rate')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                ...
                <!-- Image -->
                <div class="mb-6">
                    <label for="image" class="block text-sm font-medium text-gray-700 mb-2">Change Product Image (leave empty to keep current)</label>
    ...
    <script>
        ...
        function addColorVariation() {
                    ...
                    <div>
                        ...
                        <div class="flex gap-2">
                            <input type="color" name="colors[${colorIndex}][hex_code]" 
                                   value="#000000"
                                   class="w-12 h-10 border border-gray-300 rounded cursor-pointer">
                            <input type="text" name="colors[${colorIndex}][hex_code]" 
                                   value="#000000"
                                   placeholder="#000000"
                                   class="flex-1 px-3 py-2 border border-gray-300 rounded focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                        </div>
            ...
            // Show delete buttons on all items if there's more than one
